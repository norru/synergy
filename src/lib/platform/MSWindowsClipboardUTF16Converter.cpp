...
std::string
MSWindowsClipboardUTF16Converter::doFromIClipboard(const std::string& data) const
{
...
std::string
MSWindowsClipboardUTF16Converter::doToIClipboard(const std::string& data) const
{
