...
public:
	...
	*/
	virtual nstring	getOSName() const = 0;

	//! Identify the platform
	/*!
	Returns a string identifying the platform this OS is running on.
	*/
	virtual nstring getPlatformName() const = 0;
	//@}
	...
	*/
	virtual nstring setting(const nstring& valueName) const = 0;
	//@}
	...
	*/
	virtual void setting(const nstring& valueName, const nstring& valueString) const = 0;
	//@}
	...
	*/
	virtual nstring getLibsUsed(void) const = 0;
	//@}
};
