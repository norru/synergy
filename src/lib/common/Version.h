...
// important strings
extern const nchar* kApplication;
extern const nchar* kCopyright;
extern const nchar* kContact;
extern const nchar* kWebsite;

// build version.  follows linux kernel style:  an even minor number implies
// a release version, odd implies development version.
extern const nchar* kVersion;

// application version
extern const nchar* kAppVersion;
