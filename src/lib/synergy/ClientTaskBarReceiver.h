...
public:
	...
	*/
	void				updateStatus(Client*, const nstring& errorMsg);

	void updateStatus(INode* n, const nstring& errorMsg) { updateStatus((Client*)n, errorMsg); }
	...
	virtual nstring		getToolTip() const;
