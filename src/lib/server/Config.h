...
public:
	...
	private:
		void			init(const std::string& name, EDirection side,
							const Interval&);
...
private:
	...
	typedef std::map<std::string, Cell, synergy::string::CaselessCmp> CellMap;
	typedef std::map<std::string, std::string, synergy::string::CaselessCmp> NameMap;
...
public:
	...
	*/
	bool				renameScreen(const std::string& oldName,
	...
	*/
	bool				addAlias(const std::string& canonical,
	...
	*/
	bool				connect(const std::string& srcName,
							EDirection srcSide,
	...
	*/
	bool				disconnect(const std::string& srcName,
							EDirection srcSide);
	...
	*/
	bool				hasNeighbor(const std::string&, EDirection,
	...
	*/
	const ScreenOptions*
						getOptions(const std::string& name) const;
...
private:
	...
	void				parseScreens(ConfigReadContext&, const std::string&,
...
public:
	...
	IPlatformScreen::KeyInfo*
						parseKeystroke(const std::string& keystroke,
							const std::set<std::string>& screens) const;
	IPlatformScreen::ButtonInfo*
						parseMouse(const std::string& mouse) const;
